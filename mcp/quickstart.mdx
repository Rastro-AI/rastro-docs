...
This opens [dashboard.rastro.ai](https://dashboard.rastro.ai) in your browser. Log in, and the token is printed to your terminal. Copy the `RASTRO_AUTH_TOKEN` value for the next step.
...
<Tabs>
  <Tab title="Claude Code">
    ...
    claude mcp add rastro \
      -e RASTRO_AUTH_TOKEN=<token-from-login> \
      -- uvx rastro.ai
    ```
