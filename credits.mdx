...
Image generation and editing in Photo Studio use a **separate image credit balance** with tool-specific costs. Your remaining image credits are shown on the same Settings → Credits page.
